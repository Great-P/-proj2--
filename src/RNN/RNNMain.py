...
from RNNTrain import RNN_train
from RNNEvaluation import test_evaluation
...
def RNNMain():
    ...
    #     model_path = "RNN_model_10fold"+str(i)+"_proj2.h5"
    #     model.save(model_path)
...
def write_to_file(model_path,sensitivity,specifity,accuracy,f1_score,mcc):
    ...
    """
    fd = open("RNN_model_performance_proj2","a+")
